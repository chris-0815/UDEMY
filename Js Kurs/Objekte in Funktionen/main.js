...
const console_kontostand = function() {
    console.log(`${konto_1.inhaber.vorname} ${konto_1.inhaber.nachname} hat ${konto_1.kontostand}€ auf seinem Konto. KONSOLE_KONTOSTAND`);
};
